...
button_square = Button(frame, text = "square", padx = 0, pady = 0, command = square)
button_root = Button(frame, text = "root", padx = 0, pady = 0, command = rooting)
